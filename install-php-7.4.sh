...
sudo apt-get install -y php7.4-fpm php7.4-cli php7.4-curl php7.4-mbstring php7.4-xml php7.4-zip php7.4-mysql php7.4-imagick php7.4-gd
...
working. Further configuration is required. (7.4)</p>
