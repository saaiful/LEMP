...
sudo apt-get install -y php8.1-fpm php8.1-cli php8.1-curl php8.1-mbstring php8.1-xml php8.1-zip php8.1-mysql php8.1-imagick php8.1-gd
sudo sed -i s/\;cgi\.fix_pathinfo\s*\=\s*1/cgi.fix_pathinfo\=0/ /etc/php/8.1/fpm/php.ini
...
working. Further configuration is required. (8.1)</p>
