...
sudo apt-get install -y php7.3-fpm php7.3-cli php7.3-curl php7.3-mbstring php7.3-xml php7.3-zip php7.3-mysql php7.3-imagick php7.3-gd
sudo sed -i s/\;cgi\.fix_pathinfo\s*\=\s*1/cgi.fix_pathinfo\=0/ /etc/php/7.3/fpm/php.ini
...
working. Further configuration is required. (7.3)</p>
