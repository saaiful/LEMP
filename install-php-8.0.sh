...
sudo apt-get install -y php8.0-fpm php8.0-cli php8.0-curl php8.0-mbstring php8.0-xml php8.0-zip php8.0-mysql php8.0-imagick php8.0-gd
sudo sed -i s/\;cgi\.fix_pathinfo\s*\=\s*1/cgi.fix_pathinfo\=0/ /etc/php/8.0/fpm/php.ini
...
working. Further configuration is required. (8.0)</p>
